...
local function notifyLoader(text)
	pcall(function()
...
local function runKeyGate()
	...
	for _, parent in ipairs({guiParent, CoreGui}) do
		if typeof(parent) == "Instance" then
			local existing = parent:FindFirstChild("TortiKeySystemGui")
			if existing then
				existing:Destroy()
			end
		end
	...
	screenGui.Name = "TortiKeySystemGui"
	...
	panel.BackgroundColor3 = Color3.fromRGB(10, 13, 20)
	...
	panelStroke.Color = Color3.fromRGB(89, 144, 255)
	...
	subtitle.TextColor3 = Color3.fromRGB(149, 165, 196)
	subtitle.TextSize = 14
	subtitle.TextXAlignment = Enum.TextXAlignment.Left
	subtitle.Parent = panel

	local inputBox = Instance.new("TextBox")
	inputBox.Position = UDim2.fromOffset(24, 100)
	inputBox.Size = UDim2.new(1, -48, 0, 46)
	inputBox.BackgroundColor3 = Color3.fromRGB(20, 26, 40)
	...
	inputStroke.Color = Color3.fromRGB(82, 129, 224)
	...
	statusLabel.TextColor3 = Color3.fromRGB(149, 165, 196)
	statusLabel.TextSize = 13
	statusLabel.TextXAlignment = Enum.TextXAlignment.Left
	statusLabel.Parent = panel

	local activateButton = Instance.new("TextButton")
	activateButton.Position = UDim2.fromOffset(24, 184)
	activateButton.Size = UDim2.new(1, -48, 0, 38)
	...
	activateCorner.CornerRadius = UDim.new(0, 14)
	activateCorner.Parent = activateButton

	local activationResult = nil
	local busy = false
	...
	local function submitKey()
		...
		busy = true
		local enteredKey = tostring(inputBox.Text or "")

		if enteredKey ~= ACCESS_KEY then
			setStatus("wrong key", Color3.fromRGB(255, 132, 132))
			inputBox.Text = ""
			busy = false
			return
		end

		setStatus("key accepted", Color3.fromRGB(144, 255, 188))
	...
	repeat
		task.wait()
	until activationResult ~= nil

	screenGui:Destroy()
	notifyLoader("Access granted")
end
